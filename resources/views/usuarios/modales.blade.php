    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <form action="{{ route('eliminar', ['id' => $usuario->id_usuario]) }}" method="POST" enctype="multipart/form-data">
                    {{ csrf_field('PATCH') }}
                    {{ method_field('PUT') }}
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="text-center py-3">
                        <img src="{{ asset('imagenes/'.$usuario->foto) }}" alt="{{ $usuario -> foto }}" style="width: 300px; border-radius: 100px;">
                    </div>
                ...
                <form action="{{ route('salvar', ['id' => $usuario->id_usuario]) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row py-2">
                        <div class="col">
                            ...
                            <input type="text" class="form-control" aria-label="First name" name="nombre" value="{{ $usuario -> nombre }}">
                        </div>
                        <div class="col">
